...
for name, from_person in [("sara", from_sara), ("chris", from_chris)]:
    for path in from_person:
        ...
        import re
        bad = re.compile('sara|chris|shackleton|germani|sshacklensf|cgermannsf')
        text = re.sub(bad,'',text)
        ### append the text to word_data
        word_data.append(" ".join(text.split()))
...
word_data = pickle.load( open("./text_learning/your_word_data.pkl", "r") )
from_data = pickle.load(  open("./text_learning/your_email_authors.pkl", "r") )
...
# vnsw = TfidfVectorizer(input='content')
tfidf = vectorizer.fit_transform(word_data)
words = vectorizer.get_feature_names()
# tfidfnsw = vnsw.fit_transform(word_data)
print(len(vectorizer.get_feature_names()))
# sw =  set(vnsw.get_feature_names())-set(vectorizer.get_feature_names())
